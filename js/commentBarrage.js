...
var commentBarrageConfig = {
	...
	barrageTime: 4000,
	//twikoo部署地址腾讯云的为环境ID
	twikooUrl: "https://twikoo.meuicat.com/",
	//token获取见上方
...
function popCommentBarrage(data){
	...
	barrage.innerHTML = `
		<div class="barrageHead">
      		<a class="barrageTitle" href="javascript:icat.scrollTo(' rel="external nofollow noreferrer"post-comment')"">热评</a>
			<div class="barrageNick">${data.nick}</div>
			<img class="barrageAvatar" src="https://cravatar.cn/avatar/${data.mailMd5}"/>
			<a class="comment-barrage-close" href="javascript:icat.switchCommentBarrage()" rel="external nofollow noreferrer"><i class="iconfont icat-close"></i></a>
		</div>
		<a class="barrageContent" href="javascript:icat.scrollTo(' rel="external nofollow noreferrer"${data.id}');">${data.comment}</a>
	`
